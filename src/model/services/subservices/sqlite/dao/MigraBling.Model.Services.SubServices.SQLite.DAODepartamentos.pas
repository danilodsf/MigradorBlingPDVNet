...
type
  ...
  public
    function Ler: TObjectList<TDepartamento>; overload;
    function Ler(AID: string): TDepartamento; overload;
...
function TDAODepartamentosSQLite.Ler(AID: string): TDepartamento;
begin
  Result := nil;
end;
